...
#include "agents/FindingOfLakesWithBiggerAreaAgent.hpp"
...
sc_result ExampleModule::InitializeImpl()
{
  ...
  SC_AGENT_REGISTER(FindingOfLakesWithBiggerAreaAgent)
...
{
  SC_AGENT_UNREGISTER(FindingOfLakesWithBiggerAreaAgent)
